		...
		<div class="box">
			...
			<div class="box-content">
				<div class="padded">
					...
					<p>Upload an <?php echo ucfirst(RECONCILE_PERSONALY);?> lead report to add missing transactions for users.</p>
					...
					<div class="box">
						<table cellpadding="0" cellspacing="0" class="table table-normal">
							...
							<tbody>
								<tr>
									<td>Partner lead id</td>
									<td>Partner offer id</td>
									<td>MV user id</td>
									<td>Panelist payout in points</td>
									<td>Datetime in format(dd/mm/yy hh:ii)</td>
								</tr>
							</tbody>
						</table>
					</div>
