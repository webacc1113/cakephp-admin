...
<div class="box">
	...
	<div class="box-content">
			...
			<div class="span12">
				<div class="padded">
					<div class="alert alert-danger">
						Important: Only edit sources which have NOT been launched publicly yet.
					</div>
					...
					<?php echo $this->Form->input('post_registration_pixel', array(
						'type' => 'textarea',
						'after' => '<small>Supported special variables: <code>{{USER_ID}}</code></small>'
					)); ?>
		...
		<div class="form-actions">
			<?php echo $this->Form->submit('Save Source', array('class' => 'btn btn-primary')); ?>
		</div>
	</div>
</div>
