		...
		<div class="row-fluid">
			<div class="span4">
				<div class="padded">
					...
					<?php echo $this->Form->input('router_priority', array('type' => 'text', 'value' => 1)); ?>
					...
					<?php echo $this->Form->input('use_mask', array('label' => 'Use Mask', 'type' => 'select', 'options' => array('0' => 'No', '1' => 'Yes'), 'value' => 1)); ?>
					<?php echo $this->Form->input('calculate_margin', array('label' => 'Calculate Margin', 'type' => 'select', 'options' => array('0' => 'No', '1' => 'Yes'), 'value' => '0')); ?>
					<?php echo $this->Form->input('check_links', array('label' => 'Check Links', 'type' => 'select', 'options' => array('0' => 'No', '1' => 'Yes'), 'value' => '0')); ?>
				</div>
			</div>
		</div>
		<div class="form-actions">
			<?php echo $this->Form->submit('Create Group', array('class' => 'btn btn-primary')); ?>
		</div>
	</div>
</div>
